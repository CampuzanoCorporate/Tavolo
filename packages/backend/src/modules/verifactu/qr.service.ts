...
const AEAT_VERIFY_BASE_URL = {
  production:
    'https://www2.agenciatributaria.gob.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SistemaFacturacion/VerificacionFactura',
  preproduction:
    'https://prewww2.aeat.es/static_files/common/internet/dep/aplicaciones/es/aeat/tike/cont/ws/SistemaFacturacion/VerificacionFactura',
} as const;
