...
export const ticketsApi = {
  ...
  getCashClosurePreview: (closureId: number) =>
    apiClient.get<{ data: { id: number; preview: string; rawBase64: string } }>(`/api/tickets/cash-closures/${closureId}/preview`).then((r) => r.data.data),
  getCashClosureRaw: (closureId: number) =>
